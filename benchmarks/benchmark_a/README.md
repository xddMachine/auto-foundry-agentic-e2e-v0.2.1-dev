# Benchmark A — v0.2.6/core v0.3.3 preparation package

Benchmark A is prepared for a later, controlled comparison of the v0.2.6
skill and `auto_foundry_core` v0.3.3 against the recorded v0.2.0 baseline. It
