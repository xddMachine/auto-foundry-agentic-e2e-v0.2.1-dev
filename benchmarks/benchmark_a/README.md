# Benchmark A — v0.2.5/core v0.3.2 preparation package

Benchmark A is prepared for a later, controlled comparison of the v0.2.5
skill and `auto_foundry_core` v0.3.2 against the recorded v0.2.0 baseline. It
