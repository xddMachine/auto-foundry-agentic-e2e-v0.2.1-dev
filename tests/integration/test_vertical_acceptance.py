...
def test_complete_generic_offline_vertical_path(tmp_path: Path) -> None:
    ...
    # Requirement records remain one-parent user-owned metadata.  The
    # requirement-mode execution plan lives on each parent item rather than
    # in a cross-requirement planner.
    review_unavailable = {
